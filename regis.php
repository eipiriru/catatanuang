<?php
    ...
    {
        $regis = regis($con, $_POST['nama_lengkap'], $_POST['username'], $_POST['email'], $_POST['password']);
        if ($regis != "save")
        {
            echo '<script language="javascript">
              alert ("Username sudah ada atau coba lagi nanti");
              </script>';
        }
        else
        {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6" style="opacity: 1.9">
                                <div class="card shadow-lg border-0 rounded-lg mt-5  bg-primary-sd">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo $url;?>/regis.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" type="text" name="email" placeholder="Masukan Username"/>
                                            </div>
                                            <div class="form-group">
                                                <label class="mb-1" for="inputEmailAddress">Nama Lengkap</label>
                                                <input class="form-control py-4" id="inputEmailAddress" type="text" name="nama_lengkap" placeholder="Masukan Username"/>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-start">
                                                <input type="submit" name="daftar" class="btn btn-block btn-primary" value="DAFTAR">
                                            </div>
                                            <h5>or</h5>
                                            <div class="form-group d-flex align-items-center justify-content-start">
