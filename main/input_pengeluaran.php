<?php
    ...
    if (isset($_POST['simpan'])) 
    {
        ...
        $status = input_pengeluaran($con, $nama, $nominal);
        
        if ($status == "ok")
        {
            echo "<script language='javascript'>window.location.href = '".$url."/main/pengeluaran.php'</script>";
        }
        else
        {
                ...
                <main>
                    <div class="container-fluid" id="pagenow" data-page="pengeluaran">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo $url."/main/pengeluaran.php" ?>">Pengeluaran</a></li>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="input_pengeluaran.php">
                                            <div class="form-group">
                                                <label for="exampleTextarea">Nama pengeluaran</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-danger" name="batal" id="batal" onclick="window.location = '<?php echo $url; ?>/main/pengeluaran.php'">Batal</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
